...
- **FR-006**: System MUST restrict queries to a bounded depth (e.g., *1..2 hops).
- **FR-007**: System MUST paginate query results exceeding 5 connected nodes.
...
- **FR-017**: System MUST require explicit human approval for destructive modifications to global nodes or MetaTypes (Supreme Court).
...
- **SC-005**: The Circuit Breaker successfully engages and blocks further attempts after exactly 3 validation failures.
